BrutOrNet = int(input("Type 1 for salary brut to salary net and Type 2 for salary net to salary brut"))

if BrutOrNet == 1:
    Salary = int(input("Enter your salary brut: "))
    SalaryAfter = Salary
    ...
    Salary = int(input("Enter your salary net: "))
    SalaryAfter = Salary
